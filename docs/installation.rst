...
It's recommended to install in a fresh virtual environment, for example using `pipenv <https://pipenv.pypa.io>`_, in which case the command becomes ``pipenv install medil``.
..
